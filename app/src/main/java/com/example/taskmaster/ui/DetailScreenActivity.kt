    ...
    class DetailScreenActivity : AppCompatActivity() {
        ...
        private val taskService = ApiClient.getClient().create(TaskService::class.java)
        ...
        private fun updateTaskItem(description: String, isChecked: Boolean) {
            ...
            if (taskItemIndex != -1) {
                ...
                taskService.updateTaskItem(taskItem.id_task, taskItem.id, taskItem).enqueue(object : Callback<TaskItem> {
        ...
        private fun deleteTaskItem(description: String) {
            ...
            if (taskItemIndex != -1) {
                ...
                taskService.deleteTaskItem(taskItem.id_task, taskItem.id).enqueue(object : Callback<Void> {
